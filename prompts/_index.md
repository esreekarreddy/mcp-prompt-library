...
| [Deep Debugger](analysis/deep-debugger.md) | Analysis | Complex multi-layer debugging |
...
| [Security Hardening](quality/security-hardening.md) | Quality | Comprehensive security hardening |
...
| [Agentic Loop](agentic/agentic-loop.md) | Agentic | Self-improving AI agent loop |
| [Context Manager](agentic/context-manager.md) | Agentic | Managing AI context windows |
| [Test Driven Fix](agentic/test-driven-fix.md) | Agentic | TDD-based bug fixing |
...
- [deep-debugger.md](analysis/deep-debugger.md) - Multi-layer debugging for complex issues
...
- [security-hardening.md](quality/security-hardening.md) - Comprehensive security hardening
...
| Bug Fix | Deep Debugger + Ultrathink modifier |
| Code Cleanup | Tech Debt Audit → Code Cleaner |
| Pre-Launch | Security Audit → Security Hardening → Pre-Launch Checklist |
| Agentic Development | Context Manager → Agentic Loop → Test Driven Fix |
